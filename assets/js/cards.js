...
const cards = document.querySelectorAll(".memory-card,.memory-card2,.memory-card3");
...
(function shuffle() {
    cards.forEach((card) => {
        let randomPosition = Math.floor(Math.random() * 24); //Math.random returns random number between 0 and 1 excluding 1, so * 24 to get 24 numbers
